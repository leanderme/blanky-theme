 ...
 */
function roots_bottom_sidebar_params($params) {

    $sidebar_id = $params[0]['id'];

    if ( $sidebar_id == 'sidebar-footer' || $sidebar_id == 'toppanel' ) {
...
add_filter('dynamic_sidebar_params','roots_bottom_sidebar_params');
